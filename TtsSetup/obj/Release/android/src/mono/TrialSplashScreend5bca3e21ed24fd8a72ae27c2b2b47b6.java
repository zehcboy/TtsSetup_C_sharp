...
public class TrialSplashScreend5bca3e21ed24fd8a72ae27c2b2b47b6 extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreend5bca3e21ed24fd8a72ae27c2b2b47b6.this, ttssetup.TestVoiceAsync.class);
