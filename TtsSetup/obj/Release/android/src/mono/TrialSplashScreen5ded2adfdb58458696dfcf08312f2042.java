...
public class TrialSplashScreen5ded2adfdb58458696dfcf08312f2042 extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen5ded2adfdb58458696dfcf08312f2042.this, ttssetup.VoiceSelector.class);
