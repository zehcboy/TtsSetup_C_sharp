...
public class TrialSplashScreenc63a5e9b57a4480486ea32a469e4233e extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreenc63a5e9b57a4480486ea32a469e4233e.this, ttssetup.VoiceSelector.class);
