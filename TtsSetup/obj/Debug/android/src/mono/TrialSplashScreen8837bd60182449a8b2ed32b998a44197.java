...
public class TrialSplashScreen8837bd60182449a8b2ed32b998a44197 extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen8837bd60182449a8b2ed32b998a44197.this, ttssetup.TestVoiceAsync.class);
