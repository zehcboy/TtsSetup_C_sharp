...
public class TrialSplashScreen80cbc5f066da407f94a7ac0b0f8e81fa extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen80cbc5f066da407f94a7ac0b0f8e81fa.this, ttssetup.VoiceSelector.class);
