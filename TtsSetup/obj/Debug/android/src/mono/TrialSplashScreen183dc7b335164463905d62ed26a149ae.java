...
public class TrialSplashScreen183dc7b335164463905d62ed26a149ae extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen183dc7b335164463905d62ed26a149ae.this, ttssetup.TestVoiceAsync.class);
