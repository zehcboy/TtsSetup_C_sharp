...
public class TrialSplashScreen69bacfdf373446cd8fca111b7dbb1f9e extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen69bacfdf373446cd8fca111b7dbb1f9e.this, ttssetup.TestVoiceAsync.class);
