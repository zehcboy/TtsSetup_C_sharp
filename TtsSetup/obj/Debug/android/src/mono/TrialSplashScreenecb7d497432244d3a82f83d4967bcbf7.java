...
public class TrialSplashScreenecb7d497432244d3a82f83d4967bcbf7 extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreenecb7d497432244d3a82f83d4967bcbf7.this, ttssetup.TestVoiceAsync.class);
