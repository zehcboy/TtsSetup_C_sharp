...
public class TrialSplashScreen086688032b394bb8a484f1add86c89ac extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen086688032b394bb8a484f1add86c89ac.this, ttssetup.VoiceSelector.class);
