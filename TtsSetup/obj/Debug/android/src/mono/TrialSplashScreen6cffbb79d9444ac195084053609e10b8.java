...
public class TrialSplashScreen6cffbb79d9444ac195084053609e10b8 extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen6cffbb79d9444ac195084053609e10b8.this, ttssetup.VoiceSelector.class);
