...
public class TrialSplashScreenae6a6e3b864a4b3493245fbdb8356bd9 extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreenae6a6e3b864a4b3493245fbdb8356bd9.this, ttssetup.TestVoiceAsync.class);
