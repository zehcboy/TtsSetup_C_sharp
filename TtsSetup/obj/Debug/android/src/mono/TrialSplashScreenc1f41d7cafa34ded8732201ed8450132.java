...
public class TrialSplashScreenc1f41d7cafa34ded8732201ed8450132 extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreenc1f41d7cafa34ded8732201ed8450132.this, ttssetup.VoiceSelector.class);
