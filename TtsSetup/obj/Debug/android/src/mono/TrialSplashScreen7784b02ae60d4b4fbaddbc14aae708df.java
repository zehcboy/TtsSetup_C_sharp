...
public class TrialSplashScreen7784b02ae60d4b4fbaddbc14aae708df extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen7784b02ae60d4b4fbaddbc14aae708df.this, ttssetup.VoiceSelector.class);
