...
public class TrialSplashScreenc01f09845a8a40b2ac631fb26f021211 extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreenc01f09845a8a40b2ac631fb26f021211.this, ttssetup.TestVoiceAsync.class);
