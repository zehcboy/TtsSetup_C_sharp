...
public class TrialSplashScreen67966f84deff441497bda5de8a6bcee5 extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen67966f84deff441497bda5de8a6bcee5.this, ttssetup.VoiceSelector.class);
