...
public class TrialSplashScreen0a6958352a014a08877fffaa17cd2730 extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen0a6958352a014a08877fffaa17cd2730.this, ttssetup.TestVoiceAsync.class);
