...
public class TrialSplashScreen5cd3b082fe1e4abeabda10559aef8f01 extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen5cd3b082fe1e4abeabda10559aef8f01.this, ttssetup.TestVoiceAsync.class);
