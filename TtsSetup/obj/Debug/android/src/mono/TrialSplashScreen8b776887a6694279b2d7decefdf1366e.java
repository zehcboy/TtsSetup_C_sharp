...
public class TrialSplashScreen8b776887a6694279b2d7decefdf1366e extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen8b776887a6694279b2d7decefdf1366e.this, ttssetup.TestVoiceAsync.class);
