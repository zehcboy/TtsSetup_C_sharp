...
public class TrialSplashScreen369dff51c62e4bc2a2fc404fea3fd47d extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen369dff51c62e4bc2a2fc404fea3fd47d.this, ttssetup.VoiceSelector.class);
