...
public class TrialSplashScreen6934dab4360f4ff9b866213a148df438 extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen6934dab4360f4ff9b866213a148df438.this, ttssetup.VoiceSelector.class);
