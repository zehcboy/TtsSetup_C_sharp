...
public class TrialSplashScreendc6c3463f0b34a108dc8dc0cd74e1b10 extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreendc6c3463f0b34a108dc8dc0cd74e1b10.this, ttssetup.TestVoiceAsync.class);
