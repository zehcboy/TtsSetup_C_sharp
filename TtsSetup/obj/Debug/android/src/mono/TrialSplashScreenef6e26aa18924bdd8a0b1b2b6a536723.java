...
public class TrialSplashScreenef6e26aa18924bdd8a0b1b2b6a536723 extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreenef6e26aa18924bdd8a0b1b2b6a536723.this, ttssetup.VoiceSelector.class);
